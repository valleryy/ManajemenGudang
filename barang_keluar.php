...
<header>
  ...
  <nav>
    ...
    <a href="/MANAJEMENGUDANG/barang_keluar.php" class="active">Barang Keluar</a>
    <a href="logout.php" style="background: #edd016ff;">Logout</a>
  </nav>
</header>

<h2>📦 Data Barang Keluar</h2>
<a href="tambah_keluar.php">+ Tambah Barang</a>
<br><br>
...
<?php
$no = 1;
$query = "SELECT * FROM barang_keluar ORDER BY id_keluar ASC";
...
<tr>
  ...
  <td><?= date('d-m-Y', strtotime($d['Tanggal_keluar'])); ?></td>
   <td><?= $d['Keterangan']; ?></td>
  <td>
    <a class="btn-edit" href="edit.php?id=<?= $d['id_keluar']; ?>">Edit</a>
    <a class="btn-hapus" href="hapus.php?id=<?= $d['id_keluar']; ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
  </td>
</tr>
<?php } ?>
</table>
